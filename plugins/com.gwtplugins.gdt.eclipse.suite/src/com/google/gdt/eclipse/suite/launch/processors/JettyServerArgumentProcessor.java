...
/**
 * Processes the "-server" argument for Jetty.
 */
public class JettyServerArgumentProcessor implements ILaunchConfigurationProcessor {
  ...
  public void update(ILaunchConfigurationWorkingCopy launchConfig, IJavaProject javaProject, List<String> programArgs,
    ...
    String serverClass = WebAppLaunchConfiguration.getServerClass(launchConfig);
