...
/**
 * Launches the Jetty 12 referenced by JETTY_HOME Environment with JEE10 (jakarta.servlet) API. 
 * <BR>
...
public class Jetty12Launcher extends AbstractJetty12Launcher
{
   ...
   protected String getBootstrapClassname() {
	  return "com.gwtplugins.jettylauncher.jee10.Bootstrap";
   }

   @Override
   protected JEEVersion getJEEVersion() {
	  return JEEVersion.JEE10;
   }
}